...
var AutoFill = function( dt, opts )
{
	...
	this.dom = {
		...
		list: $('<div class="dt-autofill-ListTicket">'+this.s.dt.i18n('autoFill.info', '')+'<ul/></div>'),
	...
	_editor: function ( cells )
	{
		...
		for ( var i=0, ien=cells.length ; i<ien ; i++ ) {
			for ( var j=0, jen=cells[i].length ; j<jen ; j++ ) {
				...
				// Keep a ListTicket of cells so we can activate the bubble editing
				// with them
...
AutoFill.actions = {
	...
	// automatically by AutoFill if a multi-choice ListTicket is shown. This allows
	// sensible code reuse
	cancel: {
		available: function () {
			return false;
