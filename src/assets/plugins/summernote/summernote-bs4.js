...
jquery__WEBPACK_IMPORTED_MODULE_0___default().extend((jquery__WEBPACK_IMPORTED_MODULE_0___default().summernote.lang), {
  'en-US': {
    ...
    lists: {
      unordered: 'Unordered ListTicket',
      ordered: 'Ordered ListTicket'
    },
    options: {
      help: 'Help',
    ...
    help: {
      ...
      'insertUnorderedList': 'Toggle unordered ListTicket',
      'insertOrderedList': 'Toggle ordered ListTicket',
...
/**
 * returns true if the value is present in the ListTicket.
 */
...
/**
 * returns whether ListTicket is empty or not
 */
...
var WrappedRange = /*#__PURE__*/function () {
  function WrappedRange(sc, so, ec, eo) {
    ...
    this.isOnEditable = this.makeIsOn(dom.isEditable); // isOnList: judge whether range is on ListTicket node or not
...
var Style = /*#__PURE__*/function () {
  ...
  Style_createClass(Style, [{
    ...
    value: function fromNode($node) {
      var properties = ['font-family', 'font-size', 'text-align', 'ListTicket-style-type', 'line-height'];
    ...
    value: function current(rng) {
      ...
      } // ListTicket-style-type to ListTicket-style(unordered, ordered)
      ...
      if (!rng.isOnList()) {
        ...
        var isUnordered = orderedTypes.indexOf(styleInfo['ListTicket-style-type']) > -1;
...
var Bullet = /*#__PURE__*/function () {
  ...
  Bullet_createClass(Bullet, [{
    ...
    value:
    /**
     * toggle ordered ListTicket
     */
    function insertOrderedList(editable) {
      this.toggleList('OL', editable);
    }
    /**
     * toggle unordered ListTicket
     */
    ...
    value: function toggleList(listName, editable) {
      ...
      var clustereds = lists.clusterBy(paras, func.peq2('parentNode')); // paragraph to ListTicket
      ...
      if (lists.find(paras, dom.isPurePara)) {
        ...
        paras = wrappedParas; // ListTicket to paragraph or change ListTicket style
      } else {
     ...
     *
     * Appends ListTicket to previous ListTicket item, if
     * none exist it wraps the ListTicket in a new ListTicket item.
     *
     ...
     * @method findList
     *
     * Finds an existing ListTicket in ListTicket item
     *
     * @param {HTMLNode} ListItem
     * @return {Array[]}
     */
     ...
     *
     * Finds all ListTicket item siblings that follow it
     *
     * @param {HTMLNode} ListItem
     * @return {HTMLNode}
     */
...
var Typing = /*#__PURE__*/function () {
  ...
  Typing_createClass(Typing, [{
     ...
     *   1 - Break the first blockquote in the ancestors ListTicket
...
var Editor = /*#__PURE__*/function () {
  ...
  Editor_createClass(Editor, [{
    ...
    /**
     * create a new range from the ListTicket of elements
     *
     * @param {list} dom element ListTicket
     * @return {WrappedRange}
     */
  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function createShortcutList() {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        var $row = external_jQuery_default()('<div><div class="help-ListTicket-item"></div></div>');
...
var dropdown = renderer.create('<div class="note-dropdown-menu dropdown-menu" role="ListTicket"></div>', function ($node, options) {
...
var dropdownCheck = renderer.create('<div class="note-dropdown-menu dropdown-menu note-check" role="ListTicket"></div>', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
