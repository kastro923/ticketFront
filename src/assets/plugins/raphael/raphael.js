...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     *
     # <p>Here is short ListTicket of commands available, for more details see <a href="http://www.w3.org/TR/SVG/paths.html#PathData" title="Details of a path's data attribute's format are described in the SVG specification.">SVG path string format</a>.</p>
     ...
     * Raphael.easing_formulas
     [ property ]
     **
     * Object that contains easing formulas for animation. You could extend it with your own. By default it has following ListTicket of easing:
     # <ul>
     #     <li>“linear”</li>
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     * Adds rotation by given angle around given point to the ListTicket of
     ...
     **
     * Deprecated! Use @Element.transform instead.
     * Adds scale by given amount relative to given point to the ListTicket of
     * transformations of the element.
     > Parameters
     ...
     **
     * Deprecated! Use @Element.transform instead.
     * Adds translation by given amount to the ListTicket of transformations of the element.
     > Parameters
...
(function (glob) {
     ...
     * concated to the ListTicket of final arguments.
     ...
     * eve.off
     [ method ]
     **
     * Removes given function from the ListTicket of event listeners assigned to given name.
