...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var BASE_OPTION_REFINERS = {
        ...
        // only used by ListTicket-view, but languages define the value, so we need it in base options
        noEventsText: String,
        viewHint: identity,
    ...
    var SegHierarchy = /** @class */ (function () {
        ...
        SegHierarchy.prototype.findInsertion = function (newEntry) {
            ...
            for (var trackingLevel = 0; trackingLevel < levelCnt; trackingLevel += 1) {
                ...
                (trackingEntry = trackingEntries[lateralIndex]) && // but not past the whole entry ListTicket
    ...
    var Slicer = /** @class */ (function () {
        ...
        */
        Slicer.prototype.sliceEventRange = function (eventRange, extraArgs) {
            ...
            // hack to make multi-day events that are being force-displayed as ListTicket-items to take up only one day
            if (this.forceDayIfListItem && eventRange.ui.display === 'ListTicket-item') {
                dateRange = {
    ...
    */
    ...
    function hasListItemDisplay(seg) {
        ...
        return display === 'ListTicket-item' || (display === 'auto' &&
        ...
        TableRow.prototype.renderFgSegs = function (col, segPlacements, todayRange, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            if (framePositions) {
                for (var _i = 0, segPlacements_1 = segPlacements; _i < segPlacements_1.length; _i++) {
                    ...
                    /*
                    known bug: events that are force to be ListTicket-item but span multiple days still take up space in later columns
    ...
    var TimeColsView = /** @class */ (function (_super) {
        ...
        function TimeColsView() {
            ...
            _this.renderTableRowAxis = function (rowHeight) {
                ...
                return (
                // TODO: make reusable hook. used in ListTicket view too
    ...
    */
    ...
    function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
        ...
        for (; level < levelCnt; level += 1) {
            ...
            while ( // loop through entries that horizontally intersect
            (entry = entries[lateralEnd]) && // but not past the whole seg ListTicket
    ...
    var ListViewHeaderRow = /** @class */ (function (_super) {
        ...
        ListViewHeaderRow.prototype.render = function () {
            ...
            var classNames = ['fc-ListTicket-day'].concat(getDayClassNames(dayMeta, theme));
            // TODO: make a reusable HOC for dayHeader (used in daygrid/timegrid too)
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInnerContent, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, function (rootElRef, customClassNames, innerElRef, innerContent) { return (createElement("tr", { ref: rootElRef, className: classNames.concat(customClassNames).join(' '), "data-date": formatDayString(dayDate) },
                createElement("th", { scope: "colgroup", colSpan: 3, id: cellId, "aria-labelledby": textId },
                    createElement("div", { className: 'fc-ListTicket-day-cushion ' + theme.getClass('tableCellShaded'), ref: innerElRef }, innerContent)))); }));
        };
        return ListViewHeaderRow;
    }(BaseComponent));
    function renderInnerContent(props) {
        return (createElement(Fragment, null,
            props.text && (createElement("a", __assign({ id: props.textId, className: "fc-ListTicket-day-text" }, props.navLinkAttrs), props.text)),
            props.sideText && ( /* not keyboard tabbable */createElement("a", __assign({ "aria-hidden": true, className: "fc-ListTicket-day-side-text" }, props.sideNavLinkAttrs), props.sideText))));
    }
    ...
    var ListViewEventRow = /** @class */ (function (_super) {
        ...
        ListViewEventRow.prototype.render = function () {
            ...
            return (createElement(EventRoot, { seg: seg, timeText: "" // BAD. because of all-day content
                , disableDragging: true, disableResizing: true, defaultContent: function () { return renderEventInnerContent(seg, context); } /* weird */, isPast: props.isPast, isFuture: props.isFuture, isToday: props.isToday, isSelected: props.isSelected, isDragging: props.isDragging, isResizing: props.isResizing, isDateSelecting: props.isDateSelecting }, function (rootElRef, classNames, innerElRef, innerContent, hookProps) { return (createElement("tr", { className: ['fc-ListTicket-event', hookProps.event.url ? 'fc-event-forced-url' : ''].concat(classNames).join(' '), ref: rootElRef },
                buildTimeContent(seg, timeFormat, context, timeHeaderId, dateHeaderId),
                createElement("td", { "aria-hidden": true, className: "fc-ListTicket-event-graphic" },
                    createElement("span", { className: "fc-ListTicket-event-dot", style: { borderColor: hookProps.borderColor || hookProps.backgroundColor } })),
                createElement("td", { ref: innerElRef, headers: eventHeaderId + " " + dateHeaderId, className: "fc-ListTicket-event-title" }, innerContent))); }));
        };
    ...
    function buildTimeContent(seg, timeFormat, context, timeHeaderId, dateHeaderId) {
        ...
        if (options.displayEventTime !== false) {
            ...
            if (doAllDay) {
                ...
                return (createElement(RenderHook, { hookProps: hookProps, classNames: options.allDayClassNames, content: options.allDayContent, defaultContent: renderAllDayInner, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (createElement("td", { ref: rootElRef, headers: timeHeaderId + " " + dateHeaderId, className: ['fc-ListTicket-event-time'].concat(classNames).join(' ') }, innerContent)); }));
            }
            return (createElement("td", { className: "fc-ListTicket-event-time" }, timeText));
        }
        return null;
    }
    ...
    var ListView = /** @class */ (function (_super) {
        ...
        ListView.prototype.render = function () {
            ...
            var extraClassNames = [
                'fc-ListTicket',
                context.theme.getClass('table'),
                context.options.stickyHeaderDates !== false ? 'fc-ListTicket-sticky' : '',
            ];
        ...
        ListView.prototype.renderEmptyMessage = function () {
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.noEventsClassNames, content: options.noEventsContent, defaultContent: renderNoEventsInner, didMount: options.noEventsDidMount, willUnmount: options.noEventsWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (createElement("div", { className: ['fc-ListTicket-empty'].concat(classNames).join(' '), ref: rootElRef },
                createElement("div", { className: "fc-ListTicket-empty-cushion", ref: innerElRef }, innerContent))); }));
        };
        ListView.prototype.renderSegList = function (allSegs, dayDates) {
            ...
            return (createElement(NowTimer, { unit: "day" }, function (nowDate, todayRange) {
                ...
                return (createElement("table", { className: 'fc-ListTicket-table ' + theme.getClass('table') },
