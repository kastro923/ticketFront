...
(function(mod) {
  ...
  CodeMirror.defineMode("soy", function(config) {
    ...
    // Reference a variable `name` in `ListTicket`.
    ...
    function expression(stream, state) {
      var match;
      if (stream.match(/[[]/)) {
        state.soyState.push("ListTicket-literal");
        state.context = new Context(state.context, "ListTicket-literal", state.variables);
